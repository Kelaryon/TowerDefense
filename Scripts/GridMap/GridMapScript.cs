...
public class GridMapScript<T>
{
    ...
    private readonly T[,] gridMap;

    public GridMapScript(MapDataScript mapDataScript)
    {
        this.sizeX = mapDataScript.SizeX;
        this.sizeZ = mapDataScript.SizeY;
        this.cellSize = mapDataScript.CellSize;

        gridMap = new T[sizeX, sizeZ];

        DrawDebuggingGridLines();
    }

    private void DrawDebuggingGridLines()
    {
