...
public class Building : Structure
{
    ...
    protected Controller bank;
    public virtual bool CreateBuilding(Building buildingPrefab, Vector3 position, Controller bank, List<Waypoint> waypointList)
    {
        if (bank == null)
        {
            return false;
    ...
    //    return false;
    //}
    public virtual void Setup(List<Waypoint> wayList, Controller bank)
    {
