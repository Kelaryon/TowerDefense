...
public class Structure : MonoBehaviour,ISelectableInterface
{
    ...
    public virtual bool BuildCondition(Vector3 wayPos, GridMapScript<Waypoint> gridMap)
    {
        //Old
        ...
        List<Waypoint> wayList = gridMap.GetCellList(gridMap.GetCellList(wayPos,GetLength(),GetWidth()));
