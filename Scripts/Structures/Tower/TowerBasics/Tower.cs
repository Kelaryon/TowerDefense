...
public class Tower : Building
{
    ...
    //Tehnical
    protected TargetLocatorPrime tLocator;
    ...
    protected Action attackFuntion;
    ...
    private void Awake()
    {
        ...
        tLocator = new TargetLocatorPrime();
    }
    ...
    public override void Setup(List<Waypoint> wayList, Controller bank)
    {
    ...
    protected void Target()
    {
        ...
        //    }
        //}
        firstTarget = tLocator.GetTargetInRangeFarthestPhys(transform.position,range);
        if (firstTarget)
        {
            attackFuntion();
        }
